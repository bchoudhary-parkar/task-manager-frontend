  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const userData = {
        ...
        email: formData.email.trim().toLowerCase(), // normalize to match login behavior
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="border p-2 w-full rounded border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none"
            />
